...
map.getView().fit([-6551425.104984, -3669204.982653, -5051841.319402, -2137132.712389], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">WebSIG Portos Organizados do Rio Grande do Sul</h2>';
        return titleElement;
    })(),
